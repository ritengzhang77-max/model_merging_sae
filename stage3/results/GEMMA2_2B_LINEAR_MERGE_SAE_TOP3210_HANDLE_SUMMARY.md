...
fail the hologram probe. Bracketing the float32-SAE threshold shows top3200 and
top3200+rank3201 fail, while the sparse top3200+rank3202 handle passes the
...
handle is therefore top3200+rank3202 edge-cross; top3185 is a useful
